    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createDataModalLabel"> New Thema</h5>
				...
				<form>
                    ...
                    <div class="form-group">
                     ...
                     @if ($name > "")                    
                        ...
                        @if($error_slug!="")
                            <div class="alert alert-danger"  wire:key="error-slug-theme-off">
                                {{ $error_slug }}
                            </div>
                            @else
                            <div class="alert alert-success"  wire:key="error-slug-theme-ok">
                               slug already !!
                            </div>
                        @endif
                        @endif
...
<div wire:ignore.self class="modal fade" id="updateDataModal" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
       <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateModalLabel">Update Thema</h5>
                <button wire:click.prevent="cancel()" type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form>
