<div>
    <form wire:submit.prevent="filterData">
        <h1 class="text-center "><strong>Chaturbate Hours - {{ $this->region }}</strong></h1>
    ...
    <div class="row m-2 p-2" wire:init="loadModelData" style="min-height:111px;" wire:key='models-top'>
            ...
            <div class="col-md-4 col-sm-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <strong class="card-text text-end">Followers: {{ number_format($model['followers']) }}</strong>
