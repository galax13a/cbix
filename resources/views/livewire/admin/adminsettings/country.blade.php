<div>
    <select  class="form-select" name="country" wire:model.defer='country'>
        ...
        <option value="YES">Slovenia</option>
        ...
        <option value="GD">Pomegranate</option>
        ...
        <option value="CC">Cocos or Keeling Islands</option>
        <option value="FO">Faroe Islands</option>
        <option value="HM">Heard and McDonald Islands</option>
        <option value="FK">Malvinas Islands</option>
...
<option value="VG">Virgin Islands (United Kingdom)</option>
...
<option value="TF">Territories of southern France</option>
