    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createDataModalLabel"> New Backup</h5>
           ...
           <div class="modal-body">
				<form>
                    ...
                    <div class="form-group">
                        ...
                        <input wire:model.defer="fileurl" type="text" class="form-control" id="fileurl" placeholder="Fileurl">@error('fileurl') <span class="error text-danger">{{ $message }}</span> @enderror
                    </div>
...
<div wire:ignore.self class="modal fade" id="updateDataModal" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
       <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateModalLabel">Update Backup</h5>
                <button wire:click.prevent="cancel()" type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form>
