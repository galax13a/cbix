        ...
        <div class="modal-content">
            <div class="modal-header shadow ">
                <h5 class="modal-title" id="createDataModalLabel">
                    <i class="fas fa-rocket"></i> Create New App
                </h5>
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <select wire:model.defer="menu" class="form-control" id="menu">
                    ...
                    <div class="form-group">
                        ...
                        <select wire:model.defer="target" class="form-control" id="target">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control form-control" wire:model.defer="image" type="file" id="image"
                        placeholder="Image">
                      </div>
                      @error('image')
                      <span class="error text-danger">{{ $message }}</span>
                  @enderror
                    ...
                    <div class="form-group">
                        <label for="is_approved">Aprobación</label>
                        <select wire:model.defer="is_approved" id="is_approved" class="form-control">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="m-4">imagen4</div>
                    <br>
                    <div class="form-group">
                        <label for="formFile" class="form-label">Imagen</label>
                        <input class="form-control form-control-sm" wire:model.defer="image" type="file" id="image"
                        placeholder="Image">
                      </div>
                      @error('image')
                      <span class="error text-danger">{{ $message }}</span>
