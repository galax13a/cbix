    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createDataModalLabel"> New Appeditor</h5>
           ...
           <div class="modal-body">
				<form>
                    ...
                    <div class="form-group">
                        <label for="es"></label>
                        <input wire:model.defer="es" type="text" class="form-control" id="es" placeholder="Es">@error('es') <span class="error text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="form-group">
                        <label for="en"></label>
                        <input wire:model.defer="en" type="text" class="form-control" id="en" placeholder="En">@error('en') <span class="error text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="form-group">
                        <label for="editorjs"></label>
                        <input wire:model.defer="editorjs" type="text" class="form-control" id="editorjs" placeholder="Editorjs">@error('editorjs') <span class="error text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="form-group">
                  ...
                  <label for="table"></label>
                            <div class="form-group">
                              <x-com-select-table table-name="apps_categors" id="apps_categors_id" display-name="name" />@error('apps_categors_id') <span class="error text-danger">{{ $message }}</span> @enderror
                            </div>
                    <div class="form-group">
                  ...
                  <label for="active"></label>
                    ...
                    <div class="form-group">
                        ...
                        <input wire:model.defer="downloads" type="text" class="form-control" id="downloads" placeholder="Downloads">@error('downloads') <span class="error text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="form-group">
                        <label for="downloads_bot"></label>
                        <input wire:model.defer="downloads_bot" type="text" class="form-control" id="downloads_bot" placeholder="Downloads Bot">@error('downloads_bot') <span class="error text-danger">{{ $message }}</span> @enderror
                    </div>
