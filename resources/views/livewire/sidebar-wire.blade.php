    ...
    <div x-data="{ open: false }">
        ...
        <div :class="{ 'd-none': !open, '': open }" class="border-right sidebar-sticky floating-menu" id="sidebar-wrapper">
            <div class="list-group list-group-flush shadow-sm rounded-2">
                ...
                <a href="#" class="list-group-item list-group-item-action custom-link ">🎨 Api Chaturbate</a>                
                <a href="/api-chaturbate/" class="list-group-item list-group-item-action custom-link"> 🏅 ⛔️Account <br><span class="bg-danger p-1 text-white fw-bold rounded-3">No Completed</span> </a>   
