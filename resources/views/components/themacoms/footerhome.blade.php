<div>           
     <section>        
        <div id="footer-home" class="text-primary bg-dark border rounded-3 fixed-bottom sticky-bottom">
            <footer>
