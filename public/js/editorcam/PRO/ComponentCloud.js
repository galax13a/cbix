class ComponentCloud {
       ...
       this.toggleButton.className = 'btn btn-cb custom-link w-100';
          this.toggleButton.textContent = 'Component Cloud 📄';
...
window.ComponentCloud = ComponentCloud;
``
