class CardBlockLineImg {
    ...
    constructor({ data, api, config }) {
        ...
        label.textContent = 'Border'; // Texto que aparecerá junto al checkbox
    ...
    createAlto() {
        ...
        input.value = this.data.alto ? this.data.alto : '160'; // Valor predeterminado
    ...
    createSelectImage(cardContainer, i) {
        ...
        imgselect.className = 'p-1 m-1 punter bg-warning rounded-5';
    ...
    createSelectImage_gallery() {
        const imgselect = document.createElement('div');
        imgselect.className = 'p-1 m-1 punter bg-light rounded-5';
        imgselect.addEventListener('click', async () => {           
    ...
    generateCards() {
        ...
        let ajusteAltura = 300;
        let alturaTotal = alto + ajusteAltura;
        this.rowContainer.style.height = alturaTotal + 'px';
        ...
        for (let i = 0; i < this.columnsSelect.value; i++) {
            ...
            toolmini.className = `container-fluid d-flex align-items-center justify-content-${this.textAlignSelect.value} p-1`;
          ...
          //  cardFooter.appendChild(colorInput);
