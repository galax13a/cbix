...
class AppSeeder extends Seeder
{
    public function run()
    {
        ...
        App::create([
            'name' => 'CRM',
            'slug' => 'crm',
            'en' => 'Discover our new CMS app, your easy and fast solution for content management. With our intuitive editor, customize your website and publish content in minutes. Optimized for SEO and with high security, simplify your online presence. Install it now and start creating!',
            'is_approved' => false,
            'apps_categors_id' => 1,
        ...
        App::create([
            'name' => 'Bots',
            'slug' => 'bots',
            'en' => 'Discover Bots next generation app, your easy and fast solution for content management. With our intuitive editor, customize your website and publish content in minutes. Optimized for SEO and with high security, simplify your online presence. Install it now and start creating!',
            'is_approved' => false,
            'apps_categors_id' => 1,
            'meta_title' => 'Powerful CMS App for Easy Content Management | Streamline Your Online Presence',
            'meta_description' => 'Manage and publish content effortlessly with our powerful CMS app. Customize your website, optimize for SEO, and enhance your online presence. Install now and simplify content management',
        ...
        App::create([
            'name' => 'StudioWC',
            'slug' => 'studiowc',
            'en' => 'Introducing app studio webcam management app, designed to streamline and optimize your modeling career. With our app, you have complete control over your modeling activities, statistics, and payments, empowering you to take your webcam modeling business to new heights.',
            'is_approved' => true,
            'apps_categors_id' => 2,
